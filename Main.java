...
import java.util.List;
 ...
 public class Main {
     static Frame ventana; - - - - - - - - - - - - - - - - - //La ventana es estática para que un botón pueda cerrarla al final del programa.
     ...
     public static void main(String[] args) {
         ...
         new Output_Input(listaPokemon);- - - - - - - - - - - - // crea el archivo que llena el for

         /*------------------------------------------------------------------------------------------------------------*/

         ImageIcon icono = new ImageIcon("iconos\\18316-200.png");               //Recibir el icono de la ventana.
         ventana = new Frame("Wikidex", icono);                         //Crear la ventana, con el icono y el nombre.
